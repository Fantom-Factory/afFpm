...
// Trace dependency file for cwApp 0.2.0.225 - 14-May-2018 Mon 23:30:10 GMT/BST
...
addDep("cwApp 0.2.0.225", "sys 1.0.70-1.0, util 1.0.70-1.0, dom 1.0.70-1.0, ckit 1.0.70-1.0, graphics 1.0.70-1.0, wisp 1.0.70-1.0, web 1.0.70-1.0, cwDomain 0.2.0-1.0, cwScanner 0.2.0-1.0, cwEmails 0.2.0-1.0, cwJobs 0.2.0-1.0, cwPdf 0.2.0-1.0, afIoc 3.0.6-3.0, afIocEnv 1.1.0-1.1, afIocConfig 1.1.0-1.1, afFormBean 1.2.2-1.2, afMongo 1.1.6-1.1, afMorphia 1.2.2-1.2, afBedSheet 1.5.11-1.5, afPillow 1.1.4-1.1, afEfanXtra 1.2.0-1.2, afDuvet 1.1.8-1.1, afColdFeet 1.4.0-1.4, afSleepSafe 1.0.2-1.0, afGoogleAnalytics 0.1.6-0.1, afButter 1.2.9-1.2, concurrent 1.0.70-1.0, afBounce 1.1.9-1.1")
addDep("cwDomain 0.2.0", "sys 1.0.70-1.0, concurrent 1.0.70-1.0, graphics 1.0.70-1.0, util 1.0.70-1.0, afBeanUtils 1.0.8-1.0, afConcurrent 1.0.20-1.0, afIoc 3.0.6-3.0, afIocConfig 1.1.0-1.1, afIocEnv 1.1.0-1.1, afFormBean 1.2.2-1.2, afBson 1.1.0-1.1, afMongo 1.1.7-1.1, afMorphia 1.2.2-1.2, afButter 1.2.8-1.2, afFancordion 1.1.5-1.1, afFancordionBootstrap 1.0.2-1.0")
addDep("cwEmails 0.2.0", "sys 1.0.70-1.0, xml 1.0.70-1.0, util 1.0.70-1.0, web 1.0.70-1.0, afIoc 3.0.6-3.0, afIocConfig 1.1.0-1.1, afIocEnv 1.1.0-1.1, afButter 1.2.8-1.2, cwDomain 0.2.0-1.0, afEfanXtra 1.2.0-1.2, afSlim 1.2.0-1.2, afHtmlParser 0.1.2-0.1, afSizzle 1.0.4-1.0, afFancordion 1.1.4-1.1, afFancordionBootstrap 1.0.2-1.0")
addDep("cwJobs 0.2.0", "sys 1.0.70-1.0, fandoc 1.0.70-1.0, concurrent 1.0.70-1.0, afConcurrent 1.0.20-1.0, afIoc 3.0.6-3.0, afIocEnv 1.1.0-1.1, afIocConfig 1.1.0-1.1, afMorphia 1.2.2-1.2, afBedSheet 1.5.11-1.5, cwDomain 0.2.0-1.0, afJobby 0.0.1-1.0")
addDep("cwPdf 0.2.0", "sys 1.0.70-1.0, graphics 1.0.70-1.0, afIoc 3.0.6-3.0, afIocEnv 1.1.0-1.1, afIocConfig 1.1.0-1.1, cwDomain 0.2.0-1.0, afPdf 0.0.1-1.0")
addDep("cwScanner 0.2.0", "sys 1.0.70-1.0, util 1.0.70-1.0, concurrent 1.0.70-1.0, cwDomain 0.2.0-1.0, afConcurrent 1.0.20-1.0, afIoc 3.0.6-3.0, afIocConfig 1.1.0-1.1, afIocEnv 1.1.0-1.1, afButter 1.2.9-1.2")
...
satisfyDependencies("cwApp 0.2.0.225")
